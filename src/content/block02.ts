...
export const universityContent = {
  ...
  beats: [
    ...
    { text: 'Same five years. Same road. Both at once.', cue: 'projects' },
    { text: "She didn't know it yet —", cue: 'coop' },
    { text: 'but she was already collecting pieces of a bigger picture.', cue: 'awards' },
